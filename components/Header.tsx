...
export function Header({ user = null }: { user?: HeaderUser | null }) {
  ...
  return (
    <header className="fixed left-[248px] right-0 top-0 z-50 h-[64px] border-b border-slate-200/80 bg-white/88 shadow-sm shadow-slate-900/5 backdrop-blur-2xl max-lg:left-0">
      <div className="flex h-full w-full items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        <div className="hidden min-w-0 flex-1 justify-start lg:flex">
          <div className="relative w-full max-w-xl">
            ...
            <input
              className="h-10 w-full rounded-2xl border border-slate-200 bg-slate-50 pl-11 pr-24 text-sm font-semibold text-slate-400 outline-none"
        ...
        <div className="ml-auto flex shrink-0 items-center gap-3">
          ...
          <div className="relative">
            <button
              className="flex max-w-[280px] items-center gap-3 rounded-2xl border border-slate-200 bg-white px-3 py-2 shadow-sm transition hover:bg-emerald-50"
